...
std::u16string getPath(int mode)
{
    ...
    {
        case MODE_SAVE:
            return tou16("/3ds/jksm/saves/");
            break;
        case MODE_EXTDATA:
            return tou16("/3ds/jksm/extdata/");
            break;
        case MODE_BOSS:
            return tou16("/3ds/jksm/boss/");
            break;
        case MODE_SYSSAVE:
            return tou16("/3ds/jksm/syssave/");
            break;
        case MODE_SHARED:
            return tou16("/3ds/jksm/shared/");
            break;
        default:
            return tou16("/3ds/jksm/");
            break;
    }
}
